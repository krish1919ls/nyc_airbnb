...
##### {-}
As a result of cleaning and filtering, the records in the dataset are reduced by around 1500. The base 
levels are:
...
Below is the user interface for hosts to input parameters for suggesting the price and 95% prediction interval at which they can register his/her listing.<br/><br/>
...
<iframe src = 'https://phxlumens.shinyapps.io/recommend_listing/' height = 970px width = 850px />
